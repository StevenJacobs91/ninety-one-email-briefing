...
export const BRIEF_TEMPLATES: BriefTemplate[] = [
  ...
  {
    id: 'tpl-webinar-invitation',
    label: 'Webinar Invitation',
    description: 'Online webinar invitation with registration CTA and speaker details.',
    icon: '🎙️',
    emailType: 'webinar-invitation',
    suggestedTheme: 'agulhas-teal',
    suggestedModules: ['header-image', 'event-registration-1cta', 'speaker-2pm-1cta', 'footer-v1'],
    sectionScaffold: [
      { heading: 'About This Webinar', body: 'Describe the topic, format and why attendees should register.' },
    ],
  ...
  },
  {
    ...
    description: 'Roadshow or in-person event invitation with registration CTA.',
    icon: '🎟️',
  ...
  {
    id: 'tpl-single-content',
    label: 'Single Content',
    description: 'Focused email promoting one piece of content — an article, report or video.',
    icon: '📄',
    emailType: 'single-content',
    suggestedTheme: 'leatherback-coral',
    suggestedModules: ['header-image', 'body-content', 'cta-single-primary', 'footer-v1'],
    sectionScaffold: [
      { heading: 'Key Message', body: 'Describe the core value proposition or content highlight here.' },
    ],
    ctaLabel: 'Read Now',
    includeUnsubscribe: true,
  },
  {
    id: 'tpl-multiple-content',
    label: 'Multiple Content',
    description: 'Email featuring several pieces of content with individual CTAs per section.',
    icon: '📚',
    emailType: 'multiple-content',
    suggestedTheme: 'leatherback-coral',
    suggestedModules: ['header-small', 'body-content', 'body-inner-content', 'cta-primary-secondary', 'footer-v1'],
    sectionScaffold: [
      { heading: 'Featured Content', body: 'Introduce the first piece of content and why it matters.' },
      { heading: 'Also Worth Reading', body: 'Introduce a second piece of supporting content.' },
    ],
  ...
  },
  {
    id: 'tpl-operational',
    label: 'Operational',
    description: 'Important client communication — fund changes, regulatory updates or notices.',
    icon: '📢',
    emailType: 'operational',
    suggestedTheme: 'leatherback-coral',
    suggestedModules: ['header-small', 'body-content', 'footer-v2'],
    sectionScaffold: [
      { heading: 'What Is Changing', body: 'Clearly state the change, effective date and any action required.' },
      { heading: 'What This Means For You', body: 'Explain the practical impact and any next steps.' },
    ],
    ctaLabel: 'Contact Us',
